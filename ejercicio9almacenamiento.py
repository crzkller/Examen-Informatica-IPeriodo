...
1 - Kilobyte a Bytes
    ...
    if opcion == 1:
        ...
        entrada = float(input("Escribe la cantidad en kilobyte: "))
        resultado = round(entrada*1024)
    elif opcion == 2:
        print("Megabyte a Kilobyte")
        entrada = float(input("Escribe la cantidad en Megabytes: "))
        resultado = round(entrada*1024)
    elif opcion == 3:
        print("Gigabyte a Megabyte")
        entrada = float(input("Escrbe la cantidad en Gigabytes: "))
        resultado = round(entrada*1024)
    elif opcion == 4:
        print("Terabyte a Gigabyte")
        entrada = float(input("Escribe la cantidad en Terabytes: "))
        resultado = round(entrada*1024)
    elif opcion == 5:
        print("Petabyte a Terabyte")
        entrada = float(input("Escribe la cantidad en Petabytes: "))
        resultado = round(entrada*1024)
    elif opcion == 6:
        print("Exabyte a Petabyte")
        entrada = float(input("Escribe la cantidad en Exabytes: "))
        resultado = round(entrada*1024)
    elif opcion == 7:
        print("Yottabyte a Zetabyte")
        entrada = float(input("Escribe la cantidad en Yottabytes: "))
        resultado = round(entrada*1024)
    elif opcion == 8:
        break
