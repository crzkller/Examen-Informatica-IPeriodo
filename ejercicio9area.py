while True:
    ...
    opcion = int(input("Escribe la opción de conversión que desea utilizar: "))
    resultado = 0

    if opcion == 1:
        print("kilómetro cuadrado a Hectómetro cuadrado	")
        entrada = float(input("Escribe la cantidad en kilómetro cuadrado: "))
        resultado = round(entrada*100)
    elif opcion == 2:
        print("Hectómetro cuadrado a kilómetro cuadrado")
        entrada = float(input("Escribe la cantidad en Hectómetro cuadrado: "))
        resultado = round(entrada/100)
    elif opcion == 3:
        print("Decámetro cuadrado a Hectómetro cuadrado")
        entrada = float(input("Escribe la cantidad en Decámetro cuadrado: "))
        resultado = round(entrada/100)
    elif opcion == 4:
        ...
        entrada = float(input("Escribe la cantidad en Metro cuadrado: "))
        resultado = round(entrada/100)
    elif opcion == 7:
        print("Decámetro cuadrado a Metro cuadrado")
        entrada = float(input("Escribe la cantidad en Decámetro cuadrado: "))
        ...
        print("Metro cuadrado a Decámetro cuadrado")
        entrada = float(input("Escribe la cantidad en hectogramos: "))
        resultado = round(entrada/100)
    elif opcion == 9:
        print("Decímetro cuadrado a Centímetro cuadrado")
        entrada = float(input("Escribe la cantidad en Decímetro cuadrado: "))
        resultado = round(entrada*100)
    elif opcion == 10:
        print("Centímetro cuadrado a Decímetro cuadrado")
        entrada = float(input("Escribe la cantidad en Centímetro cuadrado: "))
        resultado = round(entrada/100)
    elif opcion == 11:
        break
