...
consumo_cliente = float(input("Escribe el consumo de agua en metros cúbicos: "))

# Calcular la factura del cliente
factura_cliente = calcular_factura_agua(consumo_cliente)

# Imprimir la factura
print(f"El consumo de agua es: {consumo_cliente} m³")
print(f"El total de la factura es: ${factura_cliente:.2f}")
