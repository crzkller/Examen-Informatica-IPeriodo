...
1 - Centrímetros a Decímetros
    ...
    opcion = int(input("Escriba la opción de conversión que quiera utilizar: "))

 
    if opcion == 1:
        print("Centrímetros a Decímetros")
        entrada = float(input("Escribe la cantidad en Centrímetros: "))
        resultado = round(entrada/10)
    
    elif opcion == 2:
        print("Decímetros a Centímetros")
        entrada = float(input("Escribe la cantidad en Decímetros: "))
        resultado = round(entrada*10)
    ...
    if opcion == 4:
     ...
     entrada = float(input("Escribe la cantidad en Metros "))
     resultado = round(entrada*10)
    ...
    if opcion == 6:
      ...
      entrada = float(input("Escribe la cantidad en Decámetros "))
      resultado = round(entrada*10)
    ...
    if opcion == 8:
      ...
      entrada = float(input("Escribe la cantidad en Hectómetro "))
      resultado = round(entrada*10)
    ...
    if opcion == 10:
      ...
      entrada = float(input("Escribe la cantidad en Kilómetro "))
      resultado = round(entrada/10)
