...
if opcion == 1:
    ...
    entrada = float(input("Escribe la cantidad en Manzanas: "))
    ...
    entrada = float(input("Escribe la cantidad en Varas cuadradas: "))
    resultado = float(entrada/10000)
elif opcion == 7:
    print("Metros Cuadrados a Manzanas")
    entrada = float(input("Escribe la cantidad en Metros Cuadrados: "))
    resultado = float(entrada/6988)
elif opcion == 8:
    print("Pies a Manzanas")
    entrada = float(input("Escribe la cantidad en Pies: "))
    resultado = float(entrada/75220.68)
elif opcion == 9:
    print("Acres a Manzanas")
    entrada = float(input("Escribe la cantidad en Acres: "))
    resultado = float(entrada/1.72677)
elif opcion == 10:
    print("Hectarea a Manzanas")
    entrada = float(input("Escribe la cantidad en Hectarea: "))
    resultado = float(entrada/0.6988)
